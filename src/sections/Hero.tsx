      ...
      <div className='flex justify-center '>
        <div className="flex justify-between ">
          <div className='w-1/2'>
            ...
            <div className='mt-4 px-2 py-1 text-white bg-[#4E2D6C] hover:bg-white hover:text-[#4E2D6C] inline-flex justify-center items-center rounded-lg border-4 border-[#4E2D6C]'>
              <button className="">
                <a href="https://www.essex.ac.uk/research-projects/cyber-security-in-uk-smes">
                  Theoretical Project
                </a>
              </button>
            </div>
