      ...
      <div className="container mx-auto ">
        <div className="flex flex-wrap items-center justify-between mt-[9.0rem] mb-[6rem]">
          <div className="w-full lg:w-[60%] mb-8 lg:mb-0">
            ...
            <p className="text-black text-[1rem] leading-relaxed">
              A cybersecurity simulation game that immerses small and medium enterprise (SMEs) managers in a virtual environment,
